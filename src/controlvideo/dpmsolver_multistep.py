...
@dataclass
class DPMSolverMultistepSchedulerOutput(SchedulerOutput):
    """
...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        return DPMSolverMultistepSchedulerOutput(prev_sample=prev_sample, pred_original_sample=model_output)
